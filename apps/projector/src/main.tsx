...
function App(){
 ...
 const boardTitle=view.state==='ROUND_TOP10'?(view.round_number?`Round ${view.round_number} · Top 10`:'Round Top 10'):(view.title??'Overall Leaderboard');
 const boardKicker=view.state==='ROUND_TOP10'?'Round standings':'Overall standings';
